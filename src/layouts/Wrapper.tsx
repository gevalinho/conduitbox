...
//       // Only initialize ScrollSmoother if 'no-smooth' class is not present
//       if (!html.classList.contains('no-smooth')) {
//         ScrollSmoother.create({
//           smooth: 1.35,
//           effects: true,
//           smoothTouch: false,
...
//   useEffect(() => {
//     // Ensure animations are only triggered when smooth scrolling is active
//     const html = document.documentElement;
//     if (!html.classList.contains('no-smooth')) {
//       // buttonAnimation()
//       // animationTitle()
